...
Uso:
    python .agent/scripts/validate_traceability.py
    python .agent/scripts/validate_traceability.py --strict
    python .agent/scripts/validate_traceability.py --output json
"""
