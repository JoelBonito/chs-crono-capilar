...
def validate_installation():
    ...
    if all_passed:
        ...
        print("  1. Instale os Git Hooks: bash .agents/scripts/install_git_hooks.sh")
        print("  2. Teste os scripts: python .agents/scripts/notifier.py test")
        print("  3. Veja a documentação: docs/DUAL_AGENT_SYSTEM.md")
        print()
        return True
    else:
        ...
        print("     chmod +x .agents/scripts/*.py")
        print()
        return False
